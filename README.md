...
站点已上线 **10 个证书体系 · 25 本备考书 · 142 个章节 · 698 道练习题**（全部章节通过 `scripts/audit.py` 检查：结构完整、weight 连续、书↔题双向一致、每题错误项均带原因）：
...
**官方动态**：软考（官网 6 条，含新版网络规划设计师大纲颁布）、教师资格（教育部教育考试院 NTCE 3 条：2026 日程、下半年报名 7/3 开始、上半年成绩 4/17 发布，小学与中学两证均收录）、初级会计（财政部会计财务评价中心 2 条：2026 考务日程通知、初/高级考试 5/16–18 举行与报考规模）、社工（中国人事考试网 4 条：2026 考试时间/报名、成绩公布、单独划线合格标准、年度工作计划）、一建（2 条：2026 报考提醒含 9/12–13 科目时刻表、报考条件与免试口径）、教师资格（教育部考试院报名流程）、会计（财政部会计财务评价中心）均**直连官方来源核验**，未核验不发布。
