...
**一页速记（考前 30 分钟）**：为报考人数最多的证书提供单页浓缩（`/yijian/cheatsheet/` 等，证书页标签「一页速记」）——数字与期限表、必背口诀与对比表、计算公式与算例、主观题/案例骨架、考场时间分配；定位是"考前 3 天只看这一页 + 错题笔记"。本批已覆盖一建、二建、监理、软考中项、教资小学、初级会计 6 个证书。
