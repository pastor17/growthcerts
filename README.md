...
站点已上线 **6 个证书体系 · 11 本备考书 · 69 个章节 · 299 道练习题**，全站 133 页、130 个可访问 URL 全部返回 200（全部章节通过 `scripts/audit.py` 检查：结构完整、weight 连续、书↔题双向一致、每题错误项均带原因）：
...
| 二级建造师 | 2 本（建设工程法规及相关知识 / 建设工程施工管理） | 6 | 24 | ✅ |
...
**后续路线**：① 二级建造师补《专业工程管理与实务》（含案例分析）；② 各证书题库继续加量至真实考情；③ 可按同样标准新增其他热门证书（软考·系统架构设计师、一级建造师、社会工作者等）。
