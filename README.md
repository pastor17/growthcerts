...
站点已上线 **9 个证书体系 · 23 本备考书 · 131 个章节 · 676 道练习题**（全部章节通过 `scripts/audit.py` 检查：结构完整、weight 连续、书↔题双向一致、每题错误项均带原因）：
...
| 二级建造师 | 4 本（法规 / 施工管理 / 实务·建筑 / 实务·市政） | 14 | 75 | ✅ |
...
**官方动态**：软考（官网 6 条，含新版网络规划设计师大纲颁布）、初级会计（财政部会计财务评价中心 2 条：2026 考务日程通知、初/高级考试 5/16–18 举行与报考规模）、社工（中国人事考试网 4 条：2026 考试时间/报名、成绩公布、单独划线合格标准、年度工作计划）、一建（2 条：2026 报考提醒含 9/12–13 科目时刻表、报考条件与免试口径）、教师资格（教育部考试院报名流程）、会计（财政部会计财务评价中心）均**直连官方来源核验**，未核验不发布。

**后续路线**：① 二建实务继续增补机电等方向；② 社工中级《社会工作法规与政策》《社会工作实务（中级）》补全，冲击中级三科齐备；② 一建实务增补机电/公路等专业方向，二建实务增补市政方向；③ 各证书题库继续加量至真实考情（软考中项 163 题为最多，其余证书继续按考情补量）；④ 官方动态持续复检（软考下半年批次安排待官网发布）。
