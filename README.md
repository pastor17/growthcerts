...
站点已上线 **9 个证书体系 · 22 本备考书 · 127 个章节 · 634 道练习题**（全部章节通过 `scripts/audit.py` 检查：结构完整、weight 连续、书↔题双向一致、每题错误项均带原因）：
...
**后续路线**：① 社工中级《社会工作法规与政策》《社会工作实务（中级）》补全，冲击中级三科齐备；② 一建实务增补机电/公路等专业方向，二建实务增补市政方向；③ 各证书题库继续加量至真实考情（PMP 33 题、二建 44 题偏少，优先补）；④ 官方动态持续复检（软考下半年批次安排待官网发布）。
